@REM cloud-contact launcher script
@REM
@REM Environment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM CLOUD_CONTACT_config.txt found in the CLOUD_CONTACT_HOME.
@setlocal enabledelayedexpansion

@echo off

if "%CLOUD_CONTACT_HOME%"=="" set "CLOUD_CONTACT_HOME=%~dp0\\.."

set "APP_LIB_DIR=%CLOUD_CONTACT_HOME%\lib\"
...
set "CFG_FILE=%CLOUD_CONTACT_HOME%\CLOUD_CONTACT_config.txt"
set CFG_OPTS=
if exist %CFG_FILE% (
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running cloud-contact.
  echo.
...
"%_JAVACMD%" !_JAVA_OPTS! !CLOUD_CONTACT_OPTS! -cp "%APP_CLASSPATH%" %MAIN_CLASS% !_APP_ARGS!
